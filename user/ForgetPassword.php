					...
					echo '<li class="dropdown">';
						...
						echo '<div class="dropdown-menu" style="padding: 15px; padding-bottom: 20px;">';
							echo '<form method="POST" action="login.php" accept-charset="UTF-8">';
								...
								echo '<a href="user/ForgetPassword.html"><u><i>forget password ?</a></i></u><br>';
							...
							echo '<a href="user/regis-Akun.html"><input class="btn btn-default btn-block" type="button" id="sign-in-google" value="SIGN UP"></a>';
...
<td>
	<div class="row clearfix">
		<div class="col-md-12 column">
			<center><img src="../img/okk.png" class="img-rounded" height="200" width="200"></center>
			<br>
			<br>
			<p class="text-center">
				<legend><font color="blue"><b>Reset Passwords</b></legend>
				</font>
			</p>
		</div>
	</div>
	<div class="row clearfix">
		<div class="col-md-12 column"><center>
				...
				<form class="form-horizontal" action = "forget.php" role="form" method="POST">
				<br>
				<div class="form-group">
					<div class="col-sm-10">
					<label for="inputKode3" class="col-sm-6 control-label">Email <font color="orange">*</font>:</label>
					<input type="text" name="email" class="form-control" id="inputKode3" placeholder="Your email" required>
					</div>
				</div><br><br>
				<div class="form-group">
					 <div class="col-sm-10">
				...
				<div class="form-group">
						<div class="col-sm-10">
							 ...
							 <input type="name" name="jawaban" class="form-control" id="inputName3" placeholder="Answer Question" required>
							</div>
						</div>
				<br><br>
				<div class="form-group">

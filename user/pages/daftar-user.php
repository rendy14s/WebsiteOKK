...
$tampil = mysql_query("Select * from user WHERE status = 'user'; ");
									...
									while ($show = mysql_fetch_array($tampil)){
                                        ...
                                        echo "<td>".$show['username']."";
										 echo "</td>";
                                          ...
                                          echo "</td>";
                                          echo "<td>";
                                          echo '<a href="DeleteUser.php?username='.$show['username'].'">Kick</a>';
                                          echo "</td>";
                                        echo "</tr>";
                                        }
										?>

    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><img src="../../img/persija/logo.png" width="40" height="40"></img> PERSIJA | ADMIN</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<form method="post" action="delete-payment.php">
                                ...
                                $kode_acara = $hasil ['kode_acara'];
								
                                 echo '<tr class="odd gradeX">';
								 ?>
                                  
                                 <td align='center'><a href ="delete-payment.php?kode_acara=<?php echo $kode_acara; ?>">Konfirmasi</td>
                                 <?php 
								 echo "       
										  <td>$username</td>      
										  <td>$an</td>

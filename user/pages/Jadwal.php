...
<td>
		<div class="col-md-12 column">
			<h5>
				<font color="black"><b>Post New Schedule</b></font>
			</h5>
		</div>
	</div>
</td>
...
<td width="10%">
	<div class="row clearfix">
		<div class="col-md-12 column">
			<form class="form-horizontal" enctype="multipart/form-data"  role="form" method="POST" action="PostJadwal.php" id="myForm">
				<br>
				<tr align="right">
				<td width="10%">
				<div class="form-group">
				<div class="col-sm-10">
					 <b>Jadwal      </b></td><td width="1%"><font color="orange">  *</font>     :</td>
				<td align="left">
				<br><br>
					<table class="table">
    <thead>
    ...
    <tbody>
      ...
      <?php
				...
				<div class="form-group">
				<div class="col-sm-10">
					 <b>Home      </b></td><td width="1%"><font color="orange">  *</font>     :</td>
				<td align="left">
					 <select class="form-control" required name="home">
					 <?php
					 ...
					 echo "<option value=$no>$tim</option>";
				...
				<div class="form-group">
				<div class="col-sm-10">
					 <b>Away     </b></td><td width="1%"><font color="orange">  *</font>     :</td>
				<td align="left">
					 <select class="form-control" required name="away">
					 <?php
					 include "../../Koneksi_Php/koneksi.php";
				...
				<div class="form-group">
				<div class="col-sm-10">
					 <b>Hari      </b></td><td width="1%"><font color="orange">  *</font>     :</td>
				<td align="left">
				...
				<td align="left">
					 <input type="date" name="tanggal" class="form-control" id="inputName3" required> <br>
					</div>
				</div>
				</td>
					</tr>
				...
				<div class="form-group">
				<div class="col-sm-10">
					 <b>Harga Tiket Kategori 1      </b></td><td width="1%"><font color="orange">  *</font>     :</td>
				<td align="left">	
						<input type="number" name="harga1" class="form-control" id="tanggal" required><br>
					</div>
				</div>
				</td>
				</tr>
				...
				<div class="form-group">
				<div class="col-sm-10">
					 <b>Harga Tiket Kategori 2      </b></td><td width="1%"><font color="orange">  *</font>     :</td>
				<td align="left">	
						<input type="number" name="harga2" class="form-control" id="tanggal" required><br>
					</div>
				</div>
				</td>
				</tr>
				...
				<div class="form-group">
				<div class="col-sm-10">
					 <b>Harga Tiket VIP Timur     </b></td><td width="1%"><font color="orange">  *</font>     :</td>
				<td align="left">	
						<input type="number" name="harga3" class="form-control" id="tanggal" required><br>
					</div>
				</div>
				</td>
				</tr>
				...
				<div class="form-group">
				<div class="col-sm-10">
					 <b>Harga Tiket VIP Barat (VVIP)   </b></td><td width="1%"><font color="orange">  *</font>     :</td>
				<td align="left">	
						<input type="number" name="harga4" class="form-control" id="tanggal" required><br>
					</div>
				</div>
				</td>
				</tr>
...
<td>
	<div class="row clearfix">
		<center><div class="col-md-12 column">
			...
			<a href="DropJadwal.php"><button type="submit" class="btn btn-default">New Jadwal</button></a>
			<a href="index.php"><button type="submit" class="btn btn-default">Done</button></a>
		</div></center>
	</div>
</td>
</tr>

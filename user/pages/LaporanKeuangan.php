...
<?php 
        ...
        <div id="page-wrapper">
            ...
            <form action="rekap.php" method="POST">
                ...
                <div class="col-sm-10">
                     <b>Dari Tanggal       </b>:   
                        <input type="date" name="tanggal_1" class="form-control" id="tanggal" required><br>

                           <b>Ke Tanggal       </b>:   
                        <input type="date" name="tanggal_2" class="form-control" id="tanggal" required><br>
                                         <button type="submit" class="btn btn-default">Print Laporan</button>
                    </div>
                </div>
            </form>   

            <!-- <h4 align="right"><a href="rekap.php">Print Laporan</a></h4> - -->
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <br>

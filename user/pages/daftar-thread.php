...
$tampil = mysql_query("Select * from post");
...
<?php 
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Daftar Thread</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									while ($show = mysql_fetch_array($tampil)){
										...
										echo "<td>".$show['post_id']."";
										echo "</td>";
                                        echo "<td>".$show['post_user']."";
										 echo "</td>";
                                          echo "<td>".$show['post_judul']."";
										  echo "</td>";
                                        echo "<td>";
                                          echo '<a href="DeleteThread.php?no='.$show['post_id'].'">Delete</a>';
                                          echo "</td>";
                                        echo "</tr>";
                                        }
										?>
